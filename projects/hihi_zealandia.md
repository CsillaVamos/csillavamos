...
![hotspot maps](../assets/images/PhD_images/change in hot spots.png)

![change in hotspot map](../assets/images/PhD_images/site hot spots with labels.png)

![Prediction map](../assets/images/PhD_images/Random Forest site maps.png)
